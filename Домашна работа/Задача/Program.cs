...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static double meterstokillometers(double meters)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Скорост в километри/час");
            Console.WriteLine(meterstokillometers(meters) / timetohours(hour, minutes, seconds));
        }
